  ...
  return (
    ...
    >
      ...
      <div className="mb-6 grid gap-4 sm:grid-cols-3">
        ...
        {[
          { icon: Camera, title: "Scan with camera", body: "Auto-crop, deskew and multi-page capture from the phone." },
          { icon: ScanText, title: "OCR queue", body: "1 document processing · average 40 seconds per page." },
      ...
      <DataTable
        headers={["Document", "Matter", "Type", "Language", "OCR", "Size", "Updated"]}
      >
        {documents.map((doc) => (
